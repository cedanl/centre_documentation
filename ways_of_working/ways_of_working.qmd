...
See for instance, the omprehensive general standard from [public code](https://github.com/publiccodenet/standard/releases). Regarding open source, we are in close contact with the [SURF OSPO](https://www.surf.nl/en/news/kick-off-community-open-source-program-office-ospo) and others within Npuls.
