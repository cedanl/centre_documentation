...
-   As part of the Npuls program, there is a request to fill in hours via [SAM](https://sam.surf.nl). This is done with your Npuls account.
    ...
    -   A link to the guide for keeping track of hours for 2024 ADD_LINK (not yet available)

    -   You only have to add the hours you actually work, so no holidays or sick days (that still goes via your regular employer)

-   Access to Teams and JIRA also goes via your Npuls / SURF account, ask the project lead for an invite link to the 'Studiedata team' within the larger SURF environment. You can also have a look at the SURF [intranet](https://surf.sharepoint.com/), the [Npuls area there](https://surf.sharepoint.com/sites/m365-NplsStAi-team/) and [Confluence](https://confluence.ia.surf.nl/pages/viewpage.action?spaceKey=NPLSSTAI&title=Npuls+Studiedata+en+Ai+Home).

-   They might ask if you want a laptop for your work at Npuls. Since most of you will only work 8 hours per week for 6 months, this seems to be an overkill.
...
-   We work mainly within an [open source github project](https://github.com/ed2c) where you get write-permissions. Let someone know if you want access on a specific account. (PS: the name ed2c refers to the old working title of ceda).
    ...
    -   For Smartgit we have some documentation available about installation and best practices. Let Corneel know if you are interested.

-   Within the pilot hub Study Data & AI, we keep track of our work on a Kanban Board. For this, as CEDA we have filters for [CEDA](https://jira.ia.surf.nl/secure/RapidBoard.jspa?rapidView=653&selectedIssue=NPLSSTAI-8&quickFilter=2057) (issues within our project only) and [CEDA only me](https://jira.ia.surf.nl/secure/RapidBoard.jspa?rapidView=653&quickFilter=2058) (only your own stories).

    -   For guidelines of the usage of the Kanboard board, see ways of working ADD_LINK

-   The project lead will invite all of you with your institutional and SURF email-adresses. If you prefer other emailadresses, let the project lead know.
...
-   See the ways-of-working document for the general expectations. Since we work agile there is no need to plan your whole project in detail.
    ...
    -   **SUGGESTION:** **make a document of max 1 A4 with bullets of the minimum viable product you want to achieve in your project the coming 3 months**

        -   [Define three 'stories' (a story is approximately a day work) with the specific first steps you want to take]{.underline}
